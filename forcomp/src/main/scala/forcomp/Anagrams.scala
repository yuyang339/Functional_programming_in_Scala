...
object Anagrams {
  ...
  def wordOccurrences(w: Word): Occurrences = {
    w.toLowerCase().groupBy((e:Char)=>e).map(e => (e._1 -> e._2.length)).toList.sortWith(_._1<_._1)
   ...
   *
   */
  lazy val dictionaryByOccurrences: Map[Occurrences, List[Word]] = collection.mutable.Map(dictionary.groupBy(wordOccurrences).toSeq: _*)
